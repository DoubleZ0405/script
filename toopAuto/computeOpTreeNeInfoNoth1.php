 ...
 * Date: 2021/1/26
 * Time: 4:22 PM
 * Brief: 计算华北1 设备版本信息 入库
 */

define ( 'ROOT_PATH', dirname ( __FILE__ ) );
ini_set ( "memory_limit", "-1" );

class computeOpTreeNeInfoNoth1 {
...
//        $this->getNeDataFromPhyNodeCol();
    ...
    public function compatibleGetNeData2Db() {
        ...
        $url = "http://northchina1.toop.woa.com/restconf/operations/nms:get-phy-node-paged";
    ...
    public function getNeDataFromPhyNodeCol() {
        ...
        foreach ($cursor as $document) {
            ...
            $curl_url = "curl -X GET --header 'Content-Type:application/json' --header 'Accept:application/json' -u ".self::$_controllerName.":".self::$_controllerPasswd." 'http://9.146.169.234/restconf/operational/network-topology:network-topology/topology/otn-phy-topology/node/$slt_ne_id'"; //toop-southchina1
...
$run = new computeOpTreeNeInfoNoth1();
$run->run();