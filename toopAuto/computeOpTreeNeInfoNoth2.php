...
class computeOpTreeNeInfoNoth2 {
...
//        $this->getNeDataFromPhyNodeCol();
    ...
    public function compatibleGetNeData2Db() {
        ...
        $url = "http://northchina2.toop.woa.com/restconf/operations/nms:get-phy-node-paged";
...
$run = new computeOpTreeNeInfoNoth2();
$run->run();