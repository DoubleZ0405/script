 ...
 * @package thrift
 */
//echo dirname(__FILE__)."/../../thrift/lib/Thrift/Protocol/TProtocol.php";
//die();
require_once(dirname(__FILE__)."/../../thrift/lib/Thrift/Protocol/TProtocol.php");
require_once(dirname(__FILE__)."/../../thrift/lib/Thrift/Transport/TTransport.php");
require_once(dirname(__FILE__)."/../../thrift/lib/Thrift/../../src/TStringUtils.php");
//require_once '../../thrift/lib/Thrift/Transport/TTransport.php';
//require_once '../../thrift/lib/Thrift/../../src/TStringUtils.php';
